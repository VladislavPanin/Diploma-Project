...
// запускать нужно так:
//      chcp 65001
//      java -Dfile.encoding=UTF-8 -Dsun.stdout.encoding=UTF-8 -jar dip.mc-etalon-1.0.jar


@SpringBootApplication
public class AppMcEtalonSumm {

	public static void main(String[] args) {
		SpringApplication.run(AppMcEtalonSumm.class, args);
                System.out.println("\n\nAppMcEtalon: Микросервис суммирования точек графика эталонной вставки стартовал\n");
	}
