...
public class ResponseHandler_params implements HttpClientResponseHandler<ConfApp> 
{    
    protected ClassicHttpResponse response = null;    
    ObjectMapper objectMapper = ConfApp.objectMapperInst();
    
    @Override
    public ConfApp handleResponse(ClassicHttpResponse response) throws HttpException, IOException {        
        ...
        {            
                     ...
                     InputStream inputStream = httpEntity.getContent()) 
                {
                        ...
                        ConfApp params = jsonParser.readValueAs(ConfApp.class);
                        return params;                
                }
        } 
        else 
